...
public class BoardController {
   ...
   public String add(Board board, HttpServletRequest request) throws Exception {
	   logger.info("board_name = " + board.getBOARD_CONTENT());
   ...
   //detail?num=9요청시 파라미터 null의 값을 int num에 저장합니다. 
   @GetMapping("/detail")
   public ModelAndView Detail(
	   ...
	   /*
	    ...
	    4. 주소창에서 http://localhost:088/myhome4/detail?num=5 엔터
   ...
   public String BoardDeleteAction(String BOARD_PASS, int num,
	   ...
	   //글 삭제 명령을 요청한 사용자가 글을 작성한 글을 작성한 사용자인지 판단하기 위해
   ...
   @PostMapping("/down")
	 ...
	 */  
	   ...
	   //context-Disposition: attachment :브라우저는 해당 content를 처리하지 않고, 다운로드 하게 됩니다. 
