...
<!-- inAnnoymous():익명 사용자인 경우 로그인 페이지로 이동하도록 합니다. -->
...
<nav class="navbar navbar-expand-sm right-blick navbar-dark">
   <!-- Brand -->
   
   <!--  1. isAuthenticated()인증한 사용자인 경우 아래의 코드를 실행합니다. 
