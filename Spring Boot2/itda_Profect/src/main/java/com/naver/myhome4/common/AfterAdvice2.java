...
// 대상 객체의 메서드를 실행하는 도중에 익셉션이 발생했는지의 여부에 상관없이 메서드 실행 후 공통 기능을 실행합니다.
// @Aspect가 설정된 클래스에는 Pointcut과 Advice를 결합하는 설정이 있어야합니다.
@Service
@Aspect
public class AfterAdvice2 {
	...
	public void afterLog(JoinPoint proceeding) {
		...
		logger.info("[AfterAdvice2] : 비즈니스 로직 수행 후 동작입니다.");
		logger.info("==========================================================================");
	}
