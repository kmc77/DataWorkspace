...
public class AroundAdvice2 {
	...
	public Object aroundLog(ProceedingJoinPoint proceeding) throws Throwable {
		...
		logger.info("=======================================================");
		logger.info("[Around Advice2의 before]: 비즈니스 메서드 수행 전입니다.");
		logger.info("=======================================================");
		...
		logger.info("[Around Advice2의 after]: " + proceeding.getTarget().getClass().getSimpleName() + "."
					+ sig.getName() + "(" + Arrays.toString(proceeding.getArgs()) + ")" );
		
		//getBoardList() 메소드 수행 시간 : 16(ms)초
		logger.info("[Around Advice2의 after]: " 
