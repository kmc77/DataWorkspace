 ...
 * Generated at: 2023-08-31 01:39:51 UTC
...
public final class member_005fjoinForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<html>\r\n");
      out.write("<head>\r\n");
      out.write("<title>loginForm.html</title>\r\n");
      out.write("<link href=\"");
      ...
      out.write("\r\n");
      out.write(" \r\n");
      out.write("    $(\"input[name=id]\").on('keyup', function() {\r\n");
      out.write("        // 처음에 pattern에 적합하지 않은 경우 메시지 출력 후 적합한 데이터를 입력해도\r\n");
      out.write("        // 계속 같은 데이터 출력하므로 이벤트 시작할 때마다 비워둡니다.\r\n");
      out.write("\r\n");
      out.write("        //[A-Za-z0-9_]의 의미가 \\w\r\n");
      out.write("        const pattern = /^\\w{5,12}$/;\r\n");
      out.write("        const id = $(\"input:eq(0)\").val();\r\n");
      out.write("        if (!pattern.test(id)) {\r\n");
      out.write("            $(\"#message\").css('color', 'red').html(\"영문자 숫자 _로 5~12자 가능합니다.\");\r\n");
      ...
      out.write("\r\n");
      out.write("    \r\n");
      out.write("    $(\"input[name=email]\").on('keyup', function() {\r\n");
      out.write("        //[A-Za-z0-9_]와 동일한 것이 \\w 입니다.\r\n");
      out.write("        //+는 1회 이상 반복을 의미하고, {1,}와 동일합니다.\r\n");
      out.write("        //\\w+는 [A-Za-z0-9_]를 1개 이상 사용하라는 의미입니다.\r\n");
      out.write("        const pattern = /^\\w+@\\w+[.]\\w{3}$/;\r\n");
      out.write("        const email_value = $(this).val();\r\n");
      out.write("\r\n");
      out.write("        if (!pattern.test(email_value)) {\r\n");
      out.write("            $(\"#email_message\").css('color', 'red').html(\"이메일 형식에 맞지 않습니다.\");\r\n");
      out.write("            checkemail = false;\r\n");
      out.write("        } else {\r\n");
      out.write("            $(\"#email_message\").css('color', 'green').html(\"이메일 형식에 맞습니다.\");\r\n");
      out.write("            checkemail = true;\r\n");
      out.write("        }\r\n");
      out.write("    }); // email key 이벤트 처리 끝\r\n");
      out.write("\r\n");
      out.write("    \r\n");
      ...
      out.write("            alert(\"사용 가능한 id로 입력하세요.\");\r\n");
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("	<form name=\"joinform\" action=\"joinProcess\" method=\"post\">\r\n");
      ...
      out.write("\r\n");
      out.write("		<b>나이</b>\r\n");
      out.write("		<input type=\"text\" name=\"age\" placeholder=\"Enter age\" maxlength=\"2\" required>\r\n");
      out.write("\r\n");
      out.write("		<b>성별</b>\r\n");
      out.write("		<div>\r\n");
      out.write("			<input type=\"radio\" name=\"gender\" value=\"남\" checked>\r\n");
      out.write("			<span>남자</span>\r\n");
      out.write("			<input type=\"radio\" name=\"gender\" value=\"여\" checked>\r\n");
      out.write("			<span>여자</span>\r\n");
      out.write("		</div>\r\n");
      out.write("\r\n");
      out.write("		<b>이메일 주소</b>\r\n");
      out.write("		<input type=\"text\" name=\"email\" placeholder=\"Enter email\" maxlength=\"30\" required>\r\n");
