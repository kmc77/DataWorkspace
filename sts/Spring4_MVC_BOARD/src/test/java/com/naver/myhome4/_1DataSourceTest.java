...
/*
 ...
 2. Test Runner는 Junit 프레임워크에서 테스트 클래스 내에 존재하는 각각의 테스트 메서드 실행을 담당하고 있는 클래스입니다.
    Junit에 내장된 기본 Test Runner은 BlockFunit4ClassRunner 입니다.
 ...
 4. @RunWith(SpringJUnit4ClassRunner.class)
    ...
    테스트를 진행하는 중에 테스트가 사용할 애플리케이션 컨텍스트를 만들고 관리하는 작업을 진행해 준비낟.
...
public class _1DataSourceTest {
	/*
	 * 1. 먼저 org.slf4j ㅠㅐ키지의 Logger, LoggerFactory 클래스를 import 합니다. import
	 * org.slf4j.Logger; import org.slf4j.LoggerFactory; 2. LoggerFactory 클래스의
	 * getLogger 메소드를 통해 Logger 객체를 생성합니다.
	 * 
	 */
