                                ...
                                <a style="text-decoration: none; color: black" href="contents/${c.chNum}/${c.boardNum}">
                                    <t:choose>
                                        <t:when test="${empty c.thumbNail}">
                                            <img class="card_img" src="${pageContext.request.contextPath }/resources/image/common/itda_logo3.png">
                                        </t:when>
                                        <t:otherwise>
                                            <img class="card_img"
                                                 src="${pageContext.request.contextPath }/resources/image/content/${c.chNum}/${c.boardDate2}/${c.thumbNail}">
