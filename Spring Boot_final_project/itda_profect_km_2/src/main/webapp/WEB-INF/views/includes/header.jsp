...
$(function(){
	...
	$("#logoutLink").click(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/member/logout.me",
...
<%-- 		const userFolder = '<%=util.dateService.toDay()%>'; --%>
		...
		if (userId) {
			...
			let profileImgPath = "";
			contextPath + "/resources/image/Member/" + userId + "/"+ userFolder + "/"
			if (userProfile != "profile.png") {
				profileImgPath += contextPath + "/resources/image/Member/" + userId + "/"+ userFolder + "/"+userProfile;
			} else {
				profileImgPath += contextPath + "/resources/image/common/profile.png";
			}
...
<div class="backyard">
	<nav id="navbody">
		<!-- 왼쪽 상단 로고 링크 -->
		<a id="logo-brand" href="${pageContext.request.contextPath}/itda/main">
			<img
		...
		<ul id="right_btns">
			...
			<div class="dropdown">
				...
				<div class="dropdown-content">
					<a href="${pageContext.request.contextPath}/member/myPage.me">마이 페이지</a>
			...
			<li id="login_modal">
				...
				<!-- Modal -->
				<form id="modalForm"
					action="${pageContext.request.contextPath}/member/loginProcess.me"
					method="post">
