		...
		<ul id="right_btns">
			...
			<li id="login_modal">
				...
				<form id="modalForm"
					...
					<div id="cocoaModal" role="dialog" aria-hidden="false"
						class="modal in modal_site_login" data-backdrop="true"
						data-keyboard="true" style="display: block; padding-left: 0px;">
							...
							<div class="modal-content">
								...
								<article class="modal_article login p_lr_space pb24">
									...
									<form action="/backpg/login.cm" method="post"
										...
										<input type="hidden" name="back_url_auth" value=""> <input
											type="hidden" name="used_login_btn" value="Y">
										...
										<div class="cheak_article">
											<div class="checkbox checkbox-styled">
												<label class="form-label"> <input type="checkbox"
													...
													checked="checked"> <span class="agree_tit">로그인상태유지</span>
												</label>
											</div>
										</div>
									...
									<div class="over_h">
										<a href="javascript:;"
											...
											class="float_l">회원가입</a> <a href="javascript:;"
									...
									<p class="txt_c mb20">
										<a class="btn !tw-block non_btn" href="javascript:;"
											onclick="SITE_MEMBER.openGuestLogin('L2RpYWxvZy9sb2dpbi5jbQ%3D%3D');">비회원
											주문배송 조회</a>
									</p>
									<script type="text/javascript">
	if ( typeof window.sessionStorage !== "undefined" ) {
		if ( typeof SITE_SHOP_DETAIL != "undefined" ) {
			if ( SITE_SHOP_DETAIL.getCurrentProdNo() ) {
				SITE_SHOP_DETAIL.saveSelectedProd();
			} else {
                const itemsToKeep = ['history_reset', 'undoList', 'redoList'];
		...
		IMWEB_SESSIONSTORAGE.clear('PROD_REVIEW_.*');
		IMWEB_SESSIONSTORAGE.clear('PROD_QNA_.*');
	}
</script>
								</article>
							</div>
