...
public class FileDown extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		/*
		 	...
		 	있게 됩니다.
		 	   (예)
		 	   		...
		 	   		2) application/octet-stream : Binary 정보를 의미하며,
		 ...
		 */
		 ...
		 /*
		  - Content-Kisposition : Content가 어떻게 처리되어야 하는지 나타냅니다.
		 ...
		 /*
		  1. try-with-resource문으로 tyr()괄호 안에 선언된 자원은 try문이 끝날 때 자동으로 close()메서드를 호출합니다.
		...
		try (
			...
			while ((numRead = in.read(b, 0, b.length)) != -1) { //읽을 데이터가 존해하는 경우
